"""CLI entry for the DOL Form 5500 lane (CI-only, never the Space).

Usage: python -m tools.ingestor.dol_5500_ingestor_cli --zip <path> --out <dir>
"""
...
def main() -> int:
    ...
    ap.add_argument("--zip", required=True, help="Path to downloaded DOL 5500 bulk ZIP")
