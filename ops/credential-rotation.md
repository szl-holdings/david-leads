...
publisher secret to update all three Hugging Face Space secrets, restarts the Space, waits for
`/healthz` to report `authentication=CONFIGURED`, proves a replacement login and logout, and emits
only the secret names and boolean verification results.
