...
def _persist(state: dict[str, dict[str, Any]] | None = None) -> None:
    if not _PATH:
        return
...
def update(
    ...
    *,
    ...
    clearance_is_current = normalized_stage in contact_stages and bool(
    ...
    candidate = {
        ...
        "clearance_confirmed": clearance_is_current,
        "updated_at": event["at"],
        "history": history[-50:],
    }
